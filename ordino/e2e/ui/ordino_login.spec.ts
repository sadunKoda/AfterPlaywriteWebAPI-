...
test.describe('Ordino Auth Sign-in - Test Suite', () => {
  ...
  test('Auth Sign-in with In-Valid Credentials', async ({ loginPage, homePage }) => {
    ...
    test('Auth Sign-in with Valid Credentials 1 ', async ({ loginPage, homePage }) => {
    await loginPage.goto()
    await loginPage.step_enterUsername("admin@platform.com")
    await loginPage.step_enterPassword("admin")
    await loginPage.step_clickLogin() 
  ...
  test('Auth Sign-in with In-Valid Credentials 3 ', async ({ loginPage, homePage }) => {
   ...
   test('Auth Sign-in with Valid Credentials error1', async ({ loginPage, homePage }) => {
    await loginPage.goto()
    await loginPage.step_enterUsername("admin@xxxxx.com")
    await loginPage.step_enterPassword("admin")
    await loginPage.step_clickLogin() 
  });

   test('Auth Sign-in with Valid Credentials error2', async ({ loginPage, homePage }) => {
    await loginPage.goto()
    await loginPage.step_enterUsername("admin@xxxxx.com")
    await loginPage.step_enterPassword("admin")
    await loginPage.step_clickLogin() 
  ...
  test('Auth Sign-in with Valid Credentials error3', async ({ loginPage, homePage }) => {
    await loginPage.goto()
    await loginPage.step_enterUsername("admin@xxxxx.com")
    await loginPage.step_enterPassword("admin")
    await loginPage.step_clickLogin() 
  ...
  test('Auth Sign-in with Valid Credentials error4', async ({ loginPage, homePage }) => {
    await loginPage.goto()
    await loginPage.step_enterUsername("admin@xxxxx.com")
    await loginPage.step_enterPassword("admin")
    await loginPage.step_clickLogin() 
